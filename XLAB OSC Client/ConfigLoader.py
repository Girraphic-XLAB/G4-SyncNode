...
LaunchUnreal = config['OSC']['LaunchUnreal']
...
UProject = config['GENERAL']['Uproject']
UnrealDir = config['GENERAL']['UnrealDirectory']
...
UELaunch =  UnrealDir + ' ' + ProjectDir + '\\' + UProject + ' -game'
